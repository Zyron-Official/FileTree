...
#### Note: 
(This Dependency is in pending in Maven for Review) you can't use this dependency at the moment, if you want to integrate FileTree you should add FileTree Locally within your project as library module.
