...
**Copy:** Use the ```java copyFile(source: File, destination: File)``` method to copy a file or folder.

**Cut:** Use the ```java moveFile(source: File, destination: File)``` method to move a file or folder.
